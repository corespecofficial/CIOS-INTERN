...
const NAV_ITEMS: NavItem[] = [
  ...
  { emoji: "📱", label: "Stories", href: "/stories", section: "SOCIAL", dataRole: ["intern", "team_lead", "mentor", "alumni", "admin", "super_admin"] },
  { emoji: "📰", label: "Articles", href: "/articles", section: "SOCIAL", dataRole: ["intern", "team_lead", "mentor", "alumni", "admin", "super_admin"] },
  { emoji: "🏆", label: "Project of the Week", href: "/voting", section: "SOCIAL", dataRole: ["intern", "team_lead", "mentor", "alumni", "admin", "super_admin"] },
  { emoji: "🏪", label: "Reward Store", href: "/rewards-store", section: "PROGRESS", dataRole: ["intern", "team_lead", "mentor", "alumni"] },
  { emoji: "🎓", label: "Alumni Badge", href: "/alumni-badge", section: "PROGRESS", dataRole: ["alumni", "intern", "team_lead", "mentor"] },
  { emoji: "📹", label: "Broadcasts", href: "/broadcasts", section: "SOCIAL", dataRole: ["intern", "team_lead", "mentor", "alumni", "admin", "super_admin", "instructor"] },
  { emoji: "🏛", label: "Institution Portal", href: "/institution", section: "TOOLS", dataRole: ["admin", "super_admin", "instructor"] },
  { emoji: "🏢", label: "Company Portal", href: "/company-portal", section: "TOOLS", dataRole: ["admin", "super_admin", "recruiter"] },
  { emoji: "🏦", label: "Government Portal", href: "/gov-portal", section: "TOOLS", dataRole: ["admin", "super_admin"] },
  { emoji: "🤝", label: "Partner Programme", href: "/partners", section: "TOOLS", dataRole: ["admin", "super_admin", "recruiter"] },
  ...
  { emoji: "🏫", label: "Organization Spaces", href: "/admin/creative-spaces", section: "ADMIN", dataRole: ["admin", "super_admin"] },
  ...
  // SUPER ADMIN \u2014 kept under its own label so the section is visually
  // distinct from the regular ADMIN block above and gets its own
  // independent collapse state. Previously every super-admin item was
  // tagged section: "ADMIN" too, which produced two undifferentiated
  // "ADMIN" headers in the rendered sidebar.
  { emoji: "\u{1F451}", label: "Super Admin", href: "/super-admin", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u{1F465}", label: "Manage Users", href: "/super-admin/users", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u{1F331}", label: "Data Seeder", href: "/super-admin/seed", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u2728", label: "AI Settings", href: "/super-admin/ai-settings", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u2709", label: "Email Settings", href: "/super-admin/email-settings", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u26A1", label: "XP & Challenges", href: "/super-admin/xp-rules", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u{1F916}", label: "AI Access", href: "/super-admin/ai-access", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u{1F3E2}", label: "Recruiter Access", href: "/super-admin/recruiter-requests", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u{1F5BC}", label: "Landing Content", href: "/super-admin/landing-settings", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u{1F30D}", label: "Public Portals", href: "/super-admin/public-portals", section: "SUPER ADMIN", dataRole: ["super_admin"] },
  { emoji: "\u{1F4E2}", label: "Broadcast", href: "/admin/broadcast", section: "SUPER ADMIN", dataRole: ["admin", "super_admin"] },
  { emoji: "\u{1F4E3}", label: "Announcements", href: "/announcements", section: "MAIN", dataRole: ["all"] },
  // PLATFORM OPS \u2014 observability, audit, security, activity. These
  // are platform-wide ops surfaces (not org / cohort admin), so they
  // get their own collapse group separate from ADMIN and SUPER ADMIN.
  { emoji: "\u{1F6E1}", label: "Announcement Control", href: "/admin/announcement-control", section: "PLATFORM OPS", dataRole: ["super_admin"] },
  { emoji: "\u{1F517}", label: "Contact Allocation", href: "/admin/contact-allocation", section: "PLATFORM OPS", dataRole: ["admin", "super_admin"] },
  { emoji: "\u{1F512}", label: "Message Control", href: "/admin/message-control", section: "PLATFORM OPS", dataRole: ["admin", "super_admin"] },
  { emoji: "\u{1F4CA}", label: "Analytics", href: "/analytics", section: "PLATFORM OPS", dataRole: ["super_admin", "admin"] },
  { emoji: "\u{1F4DC}", label: "Audit Logs", href: "/admin/audit-logs", section: "PLATFORM OPS", dataRole: ["admin", "super_admin"] },
  { emoji: "\u{1F6A8}", label: "Security Center", href: "/admin/security-center", section: "PLATFORM OPS", dataRole: ["admin", "super_admin"] },
  { emoji: "\u{1F4C8}", label: "Activity Monitor", href: "/admin/activity-monitor", section: "PLATFORM OPS", dataRole: ["admin", "super_admin"] },
  { emoji: "\u{1F4E4}", label: "Compliance", href: "/admin/compliance-reports", section: "PLATFORM OPS", dataRole: ["admin", "super_admin"] },
  { emoji: "\u{1FA7A}", label: "Observability", href: "/admin/observability", section: "PLATFORM OPS", dataRole: ["admin", "super_admin"] },
  ...
  { emoji: "🏫", label: "Org Spaces", href: "/creative-space", section: "TOOLS", dataRole: ["intern", "team_lead", "admin", "super_admin", "mentor", "alumni", "instructor"] },
  ...
  { emoji: "🎓", label: "Create Org Space", href: "/creative-space/apply", section: "INSTRUCTOR", dataRole: ["instructor", "admin", "super_admin"] },
  { emoji: "📋", label: "Manage Org Spaces", href: "/creative-space/manage", section: "INSTRUCTOR", dataRole: ["instructor", "admin", "super_admin"] },
