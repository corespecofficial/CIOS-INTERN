          ...
          await sendEmail({
            ...
            html: wrapEmail(
              `<h2 style="margin:0 0 10px 0;font-size:20px;color:#E8EDF5;">Hi ${user.name || "there"},</h2>
               ...
               <p style="margin-top:20px;"><a href="${process.env.NEXT_PUBLIC_APP_URL || ""}/courses/${course?.id || ""}" style="background:linear-gradient(135deg,#1E88E5,#1565C0);color:#fff;text-decoration:none;padding:10px 20px;border-radius:10px;font-weight:700;">View feedback →</a></p>`,
