...
export function EagleSubmissionView({ submission }: Props) {
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: undefined }}>
      {/* Header */}
      <div style={{ display: "flex", alignItems: "flex-start", gap: 16, marginBottom: 24, flexWrap: "wrap" }}>
        ...
        {submission.total_score !== null && (
          <div style={{
            ...
            <div style={{ fontSize: 28, fontWeight: 900, color: submission.total_score >= 70 ? "#4CAF50" : "#FFC107" }}>
      ...
      {status === "graded" && Object.keys(SECTION_LABELS).length > 0 && (
        <div style={{ background: "#131929", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12, padding: "16px 14px", marginBottom: 20 }}>
