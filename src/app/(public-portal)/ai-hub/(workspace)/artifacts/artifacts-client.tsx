    ...
    <div style={{ flex: 1, overflow: "auto", padding: "32px 40px" }}>
      <div style={{ maxWidth: 920, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
          <h1 style={{ margin: 0, fontSize: 28, fontWeight: 900, color: "#1F2430", letterSpacing: -0.3 }}>Artifacts</h1>
          <button
        ...
        <div style={{ borderBottom: "1px solid #EAE7DF", marginBottom: 32 }}>
          <div
            style={{
        ...
        <div style={{ padding: "60px 20px", textAlign: "center" }}>
          ...
          <div style={{ fontWeight: 800, fontSize: 20, color: "#1F2430", marginBottom: 8 }}>
            What will you build with artifacts?
          </div>
          <div style={{ color: "#55524A", fontSize: 14, lineHeight: 1.55, maxWidth: 520, margin: "0 auto 22px" }}>
