...
import { createAssignment } from "@/app/actions/org-portal";

export function AssignmentComposer({ orgId }: { orgId: string }) {
  ...
  return (
    <div style={{ background: "#111827", border: "1px solid #1F2937", borderRadius: 12, padding: 18, marginBottom: 16 }}>
      ...
      <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
        <button onClick={submit} disabled={pending || title.trim().length < 3} style={btnPrimary}>{pending ? "Saving…" : "Save"}</button>
