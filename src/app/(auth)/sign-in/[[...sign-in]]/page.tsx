  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 20, width: "100%" }}>
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "#8892A4" }}>Welcome back to CIOS Platform</p>
      </div>
      <SignIn
      ...
      <p style={{ fontSize: 12, color: "#5A6478", textAlign: "center" }}>
        ...
        <a href="/sign-up" style={{ color: "#1E88E5", fontWeight: 600, textDecoration: "none" }}>Apply for Internship</a>
      </p>
    </div>
  );
}
